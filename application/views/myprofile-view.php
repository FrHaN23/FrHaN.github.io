...
<body class="bg-dark text-white" data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50">
    ...
    <div class="bg-image img-fluid shadow-1-string mb-2 text-left text-white pl-5 " style="background-image: url(<?php echo base_url('assets/img/jumbotron.png');?>); height: 80vh; background-size:cover" id="home">
        <div class= "p-5 text-lg-fs2" style="background: rgba(0,0,0,0.25); background-size:cover; height:80vh; flex-direction:column;">
